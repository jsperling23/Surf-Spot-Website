#This script will scrape the NOAA website and fill the database table Buoys with buoy metadata
...
def getBuoyList() -> dict:
    """
    This function scrapes the station ID, coordinates, and station label from the NOAA
    website and returns a dictionary containing the coordinates as a key and a tuple of the 
    station ID/label.
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        for line, value in result.items():
            ...
            query = "INSERT INTO Buoys (stationID, latitude, longitude, description) VALUES (%s, %s, %s, %s)"
