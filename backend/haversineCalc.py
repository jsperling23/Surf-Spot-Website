...
def haversineCalc(coord: tuple) -> dict:
    try:
        ...
        gal = []
        while len(gal) < 5:
            #query Buoys entity and find all the buoys that have coordinates within 5% of given coordinates
            lowLat = coord[0] * 0.95
            ...
            #sorts by the distance and convert to a dictionary for purposes of serializing to JSON
            gal.sort()
            sortedDict = {}
            for value in gal:
